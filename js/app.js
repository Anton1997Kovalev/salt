...
let footer_slide = document.querySelectorAll('.footer__slide');
let footer_control = document.querySelector('.footer__control');
if (footer_slide.length > 1){
	footer_control.style = "display:flex;";
} else{
	footer_control.style = "display:none;";
}
...
let footer_slider = new Swiper('.footer__slider', {
	/*
	effect: 'fade',*/
/*	autoplay: {
		delay: 3000,
